...
if __name__ == '__main__':
    scene_base_dir = Path('dataset/dimos_data/scenes/random_scene_test')
    scene_name_list = [
    ...
    glob_pattern = f'./save/results_for_eval/mixed_action2motion_control/random_scene_test/*/path*/rep*/results.pkl'
